...
CONCEPT_KEYWORDS: Dict[str, List[str]] = {
    "光模块/CPO": ["光模块", "CPO", "光通信", "光器件"],
    "GPU/ASIC芯片": ["芯片", "半导体", "GPU", "ASIC", "集成电路", "AI芯片"],
    "服务器": ["服务器", "AI服务器", "算力", "数据中心", "IDC"],
    "液冷散热": ["液冷", "散热", "温控"],
    "大模型厂商": ["大模型", "ChatGPT", "AIGC", "人工智能"],
    "数据要素": ["数据要素", "数据确权", "数据交易", "大数据"],
    "算法公司": ["算法", "机器视觉", "计算机视觉"],
    "传媒游戏（AIGC）": ["AIGC", "传媒", "游戏", "短剧", "影视"],
    "办公软件": ["办公软件", "SaaS", "云办公"],
    "自动驾驶": ["自动驾驶", "无人驾驶", "智能网联", "车联网"],
    "AI+医疗": ["医疗AI", "智慧医疗", "AI医疗", "数字医疗"],
    "减速器": ["减速器", "谐波减速器", "RV减速器", "精密减速器"],
    "伺服电机": ["伺服电机", "伺服系统", "电机"],
    "传感器": ["传感器", "六维力传感器", "机器视觉", "视觉传感器"],
    "丝杠": ["丝杠", "滚珠丝杠", "行星滚柱丝杠"],
    "整机代工": ["机器人", "工业机器人", "人形机器人"],
    "系统集成": ["自动化", "工业自动化", "智能制造"],
    "工业制造": ["工业制造", "智能制造", "工业互联网"],
    "医疗机器人": ["医疗机器人", "手术机器人"],
    "家用服务机器人": ["服务机器人", "扫地机器人", "智能家居"],
}
